            ...
            <div class="p-6 space-y-6">
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="is_parent" value="1" {{ old('is_parent') ? 'checked' : '' }} id="is_parent" class="w-4 h-4 text-gold-600 border-gray-300 rounded focus:ring-gold-500">
                ...
                <div id="parent_selection" style="display: none;">
                    ...
                    <select name="parent_id" class="w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-gold-500 focus:ring-gold-500 shadow-sm transition-all">
                        ...
                        @foreach($parentCategories as $parent)
                            <option value="{{ $parent->id }}" {{ old('parent_id', $defaultParent?->id) == $parent->id ? 'selected' : '' }}>
                                {{ $parent->name_en }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div id="icon_field" style="display: none;">
                    ...
                    <input type="text" name="icon" value="{{ old('icon') }}" class="w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-gold-500 focus:ring-gold-500 shadow-sm transition-all" placeholder="e.g. machine-icon or SVG code">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name_ar" value="{{ old('name_ar') }}" class="w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-gold-500 focus:ring-gold-500 shadow-sm transition-all" placeholder="e.g. Electronics">
                    ...
                    <div>
                        ...
                        <input type="text" name="name_en" value="{{ old('name_en') }}" class="w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-gold-500 focus:ring-gold-500 shadow-sm transition-all text-left" placeholder="e.g. Electronics" dir="ltr">
                    ...
                    <div>
                        ...
                        <input type="text" name="name_fr" value="{{ old('name_fr') }}" class="w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-gold-500 focus:ring-gold-500 shadow-sm transition-all text-left" placeholder="e.g. Électronique" dir="ltr">
...
<script>
    ...
    if ({{ old('is_parent') ? 'true' : 'false' }}) {
        document.getElementById('is_parent').dispatchEvent(new Event('change'));
    }
</script>
@endsection
