...
<div class="bg-gray-50 min-h-screen py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8 pb-6 border-b border-gray-200">
            <h1 class="text-3xl font-bold text-gray-900 mb-4 md:mb-0">{{ __('Shop') }}</h1>

            <div class="flex items-center gap-4">
                <span class="text-gray-500 text-sm hidden sm:inline">{{ $products->total() }} {{ __('Products') }}</span>
        ...
        <div>
            ...
            @else
                <div class="text-center py-16 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <p class="text-gray-500">{{ __('Try changing your search options.') }}</p>
                </div>
            @endif
        </div>
    </div>
